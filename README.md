...
This project uses **React + Vite** for a fast development experience with Hot Module Replacement (HMR) and basic ESLint configuration.

Currently, two official plugins are available:

- [`@vitejs/plugin-react`](https://github.com/vitejs/vite-plugin-react/blob/main/packages/plugin-react) – uses the standard React plugin flow for Fast Refresh.  
- [`@vitejs/plugin-react-swc`](https://github.com/vitejs/vite-plugin-react/blob/main/packages/plugin-react-swc) – uses **SWC** for faster transforms and Fast Refresh.

## React Compiler

The React Compiler is not enabled in this template by default because it can affect development and build performance.
...
If you are building a production‑ready application, it is recommended to use **TypeScript** with type‑aware lint rules enabled.

You can check the official Vite TypeScript template here:  
[React + TypeScript Template](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-react-ts)

You can also learn more about TypeScript ESLint here:  
